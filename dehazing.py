...
class Dehaze(object):
    ...
    def _optimization_closure(self, step):
        ...
        self.total_loss = 5.0 * self.mseloss
...
def dehazing(opt):
    ...
    if opt.datasets == 'GLPV':
        hazy_add = 'data/' + opt.datasets + '/blurred/*.png'
        img_num = 32
    elif opt.datasets == 'HoLEP':
        hazy_add = 'data/' + opt.datasets + '/blurred/*.png'
        img_num = 16
    elif opt.datasets == 'PPE':
        hazy_add = 'data/' + opt.datasets + '/blurred/*.png'
        img_num = 49
    else:
    ...
    for item in sorted(glob.glob(hazy_add)):
        ...
        gt_add = 'data/' + opt.datasets + '/clean/' + name + '.png'
